            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        { label: '训练大师 - 瑟勒米乌斯', slug: 'characters/skelly', attrs: { 'data-icon': `${hadesSourceHost}/skelly_icon.png` } },
                        { label: '自由之灵 - 伊卡洛斯', slug: 'characters/icarus', attrs: { 'data-icon': `${hadesSourceHost}/icarus_icon.png` } },
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { label: '迪奥尼索司', slug: 'characters/dionysus', attrs: { 'data-icon': `${hadesSourceHost}/dionysus_icon.png` } },
