            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        { label: '美狄亚', slug: 'characters/medea', attrs: { 'data-icon': `${hadesSourceHost}/medea_icon.png` } },
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { label: '波吕斐摩斯', slug: 'characters/polyphemus', attrs: { 'data-icon': `${hadesSourceHost}/polyphemus_icon.png` } },
